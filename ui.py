...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(370, 500)
        Dialog.setMinimumSize(QtCore.QSize(370, 500))
...
"font-size: 24px;")
        ...
        self.teama.setGeometry(QtCore.QRect(60, 130, 200, 16))
        self.teama.setObjectName("teama")
        self.teamb = QtWidgets.QLabel(Dialog)
        self.teamb.setGeometry(QtCore.QRect(60, 160, 200, 16))
        ...
        self.status.setGeometry(QtCore.QRect(60, 210, 251, 150))
        ...
        self.commentary.setGeometry(QtCore.QRect(60, 300, 251, 250))
        self.commentary.setStyleSheet("font-size:14px;")
        ...
        self.pushButton.setStyleSheet("background:#20B2AA;\n"
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.teama.setText(_translate("Dialog", "TeamB"))
        self.teamb.setText(_translate("Dialog", "TeamA"))
